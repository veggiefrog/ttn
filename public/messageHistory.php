...
// -------
//
function va3ned_ttn_messageHistory($ciniki) {
    //
    ...
    $rc = va3ned_ttn_checkAccess($ciniki, $args['tnid'], 'va3ned.ttn.messageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'va3ned.ttn', 'va3ned_ttn_history', $args['tnid'], 'va3ned_ttn_messages', $args['message_id'], $args['field']);
}
?>
